...
import Profile from "@/components/modules/auth/profile/AuthProfile.vue";
import UserRole from "@/components/modules/auth/signIn/UserRole.vue";
...
const targetComponent = userComponentList[targetComponentName.value as string];
</script>
<style lang="scss">
.auth-input-height {
  height: 100px;
